...
export default class First extends React.Component {
    ...
    navigateEffect(){
        ...
        />
{this.state.bar?
<Animatable.View ref={this.navbar} style={{position: "absolute", top:0}}>
...
style={{top:9 ,position: "relative", shadowColor: "#000", height:200,
shadowOffset: {
	width: 0,
	height: 4,
},
...
<Button onPress={()=>{
    this.navigateEffect()
    setTimeout(()=>{this.props.navigation.navigate('TrainingMode')}, 700)
